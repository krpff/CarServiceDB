...
(1, 'Kia', 'Rio', 2019, 'KNADM512BK6123452', 'В222ВВ77', 43000),
(2, 'Hyundai', 'Solaris', 2018, 'Z94CT41BBJR123453', 'С333СС77', 52000),
...
(1, 1, '2025-01-15', 85000, 15000.00, 'Плановое обслуживание'),
(2, 2, '2025-03-10', 45000, 6500.00, 'Масло и фильтр'),
(3, 3, '2025-02-05', 55000, 12000.00, 'Передние колодки'),
(4, 4, '2025-04-20', 41000, 3500.00, 'Проверка подвески'),
(5, 5, '2025-10-01', 72000, 4000.00, 'Сезонная замена шин');

INSERT INTO fuel_record(car_id, fuel_date, mileage, liters, price_per_liter, station_name) VALUES
(1, '2025-05-01', 88000, 42.50, 58.70, 'АЗС 1'),
(2, '2025-05-02', 46200, 38.00, 59.10, 'АЗС 2'),
(3, '2025-05-03', 56000, 40.00, 57.90, 'АЗС 3'),
(4, '2025-05-04', 42000, 45.20, 60.00, 'АЗС 4'),
(5, '2025-05-05', 73000, 39.80, 58.40, 'АЗС 5');

INSERT INTO mileage_record(car_id, record_date, mileage, note) VALUES
(1, '2025-05-01', 88000, 'После поездки'),
(2, '2025-05-02', 46200, 'Ежемесячная фиксация'),
(3, '2025-05-03', 56000, 'Контроль пробега'),
(4, '2025-05-04', 42000, 'После ТО'),
(5, '2025-05-05', 73000, 'Плановая запись');
